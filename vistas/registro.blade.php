...
<div class="container position-absolute top-0 start-0">
    ...
    <div class="signup">
        <form class="" action="../includes/Registro.inc.php" method="post">
            ...
            <div class="alert alert-danger" role="alert">Usuario invalido</div>  
            @endif
            @if(isset($error) && in_array("usuarioExiste", $error)) 
            <div class="alert alert-danger" role="alert">Este nombre de usuario o email ya existe</div>  
            @endif
            ...
            <div class="alert alert-danger" role="alert">Nombre invalido</div>  
            @endif
            ...
            <div class="alert alert-danger" role="alert">Apellido invalido</div>  
            @endif
            ...
            <div class="alert alert-danger" role="alert">Telefono invalido</div>  
            @endif
            ...
            <div class="alert alert-danger" role="alert">Email invalido</div>  
            @endif
            ...
            <div class="alert alert-danger" role="alert">Contraseña invalido</div>  
            @endif
