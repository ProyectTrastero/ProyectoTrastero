...
class Registro extends App\BD {

   
    //la tabla es de prueba
    protected function agregarUsuario($usuario,$nombre,$apellido,$contrasena,$email){
        $query="insert into usuarios (usuario, contraseña, nombre, apellidos, correo) values(?, ?, ?, ?, ?, ?)";
