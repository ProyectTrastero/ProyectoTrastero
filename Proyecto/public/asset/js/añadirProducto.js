...
function iniciar(){
  ...
  //recuperamos el id de la primera balda
  let idBalda = document.getElementById('selectBaldas').childNodes[0].value;
  //enviamos el id de la balda seleccionada por default
  loadDoc('añadirProducto.php?idBalda=' + idBalda, setCajas);
  document.getElementById('selectCaja').addEventListener('change',function(){
