    ...
    <div class="container">
        <form action="">
            ...
            <div class="row mb-3">
                ...
                <button class="col col-sm-1 btn btn-outline-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="Daniel" data-bs-usuario="zapata">
